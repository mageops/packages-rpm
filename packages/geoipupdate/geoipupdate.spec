...
Source1:	https://github.com/maxmind/geoipupdate/releases/download/v%{version}/geoipupdate_%{version}_linux_arm64.tar.gz
...
find
%ifarch x86_64
%setup -q -b 0 -n geoipupdate_%{version}_linux_amd64
%endif
%ifarch aarch64
%setup -q -b 1 -n geoipupdate_%{version}_linux_arm64
%endif
...
install -D -m 755 %{SOURCE2} %{buildroot}%{_sysconfdir}/cron.weekly/geoipupdate
